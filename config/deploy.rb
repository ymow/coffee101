...
role :web, "coffee101.com"                          # Your HTTP server, Apache/etc
role :app, "coffee101.com"                         # This may be the same as your `Web` server
role :db,  "coffee101.com"   , :primary => true # This is where Rails migrations will run
